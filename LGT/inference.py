...
class LangevinSampler:
    ...
    def velocity_with_cfg(self, model, x, t, style_id, step, total_steps):
        """
    ...
    def step(self, model, x, t, style_id, dt, step_idx, total_steps):
        """
        Single Langevin integration step.
        ...
        """
        # Drift term: velocity field
        v = self.velocity_with_cfg(model, x, t, style_id, step_idx, total_steps)
    ...
    def sample(
        ...
        for step_idx in range(num_steps):
            ...
            # Langevin step
            x = self.step(model, x, t, style_id, dt, step_idx, num_steps)
...
class LGTInference:
    ...
    def transfer_style(
        ...
        2. Generation: x0 → x_target (via target style)
